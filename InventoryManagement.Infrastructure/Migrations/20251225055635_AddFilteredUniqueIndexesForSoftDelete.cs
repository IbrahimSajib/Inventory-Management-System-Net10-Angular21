        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuotationItem_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 21, 0, 0, 0, 0, DateTimeKind.Utc), "System Administrator", "Admin", null },
                    { 2, new DateTime(2025, 12, 21, 0, 0, 0, 0, DateTimeKind.Utc), "Inventory Manager", "Manager", null },
                    { 3, new DateTime(2025, 1, 12, 21, 0, 0, 0, DateTimeKind.Utc), "Regular User", "User", null }
                });
